...
type ClientHandler interface {
	PluginConnected(string, ResourcePlugin) error
...
const (
	// errFailedToDialResourcePlugin is the error raised when the device plugin could not be
	// reached on the registered socket
	errFailedToDialResourcePlugin = "failed to dial device plugin:"
