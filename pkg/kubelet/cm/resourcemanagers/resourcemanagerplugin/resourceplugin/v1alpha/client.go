...
type client struct {
	...
	client   api.ResourcePluginClient
}
...
func (c *client) Api() api.ResourcePluginClient {
	return c.client
}
...
func dial(unixSocketPath string) (api.ResourcePluginClient, *grpc.ClientConn, error) {
	...
	return api.NewResourcePluginClient(c), c, nil
}
