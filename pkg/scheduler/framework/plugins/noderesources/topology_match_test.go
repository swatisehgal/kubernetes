...
func TestTopologyRequests(t *testing.T) {
	...
	nodes["node1"] = topologyv1alpha1.NodeResourceTopology{
		...
		Nodes: []topologyv1alpha1.NUMANodeResource{
			{NUMAID: 1, Resources: v1.ResourceList{ v1.ResourceCPU: *resource.NewQuantity(4, resource.DecimalSI), v1.ResourceMemory: resource.MustParse("8Gi"), nicResourceName: *resource.NewQuantity(10, resource.DecimalSI)}},
			{NUMAID: 2, Resources: v1.ResourceList{ v1.ResourceCPU: *resource.NewQuantity(8, resource.DecimalSI), v1.ResourceMemory: resource.MustParse("8Gi"), nicResourceName: *resource.NewQuantity(4, resource.DecimalSI)}}},
	}
	nodes["node2"] = topologyv1alpha1.NodeResourceTopology{
		ObjectMeta: metav1.ObjectMeta{Name: "node2"},
		TopologyPolicy: "single-numa-node",
		Nodes: []topologyv1alpha1.NUMANodeResource{
			{NUMAID: 1, Resources: v1.ResourceList{ v1.ResourceCPU: *resource.NewQuantity(2, resource.DecimalSI), v1.ResourceMemory: resource.MustParse("4Gi"), nicResourceName: *resource.NewQuantity(5, resource.DecimalSI)}},
			{NUMAID: 2, Resources: v1.ResourceList{ v1.ResourceCPU: *resource.NewQuantity(4, resource.DecimalSI), v1.ResourceMemory: resource.MustParse("4Gi"), nicResourceName: *resource.NewQuantity(2, resource.DecimalSI)}}},
	}
  ...
  // Test different QoS Guaranteed/Burstable/BestEffort
	topologyTests := []struct {
		...
		},
		{
			...
			node: node2,
			wantStatus: nil, // number of cpu is exceeded, but in csae of burstable QoS for cpu resources we rely on fit.go
		},
		{
			pod: makePodByResourceList(&v1.ResourceList{
