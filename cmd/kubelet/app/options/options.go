...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.StringSliceVar(&c.CPUManagerPolicyOptions, "cpu-manager-policy-options", c.CPUManagerPolicyOptions, "Comma separated list of CPU Manager policy options to use, to fine tune their behaviour. If not supplied, keep the default behaviour.")
