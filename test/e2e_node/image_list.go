...
const (
	...
	SampleDevicePluginDSYAML  = "test/e2e/testing-manifests/sample-device-plugin/sample-device-plugin-auto-registration.yaml"
	SampleDevicePluginDS2YAML = "test/e2e/testing-manifests/sample-device-plugin/sample-device-plugin-control-registration.yaml"
)
